...
module.exports.run = function ({ event, args, api }) {
    ...
    switch (args[0]) {
        case "load": {
            if (moduleList.length == 0) return api.sendMessage("Le nom du module ne peut pas être vide !", threadID, messageID);
        ...
        case "info": {
            ...
            if (!command) return api.sendMessage("Le module que vous avez saisi n'existe pas !", threadID, messageID);
